...
public class PointCaptureResource {
    ...
    @GetMapping("/point-captures/autocomplete")
    public ResponseEntity<List<PointCaptureDTO>> findAutocomplete(@RequestParam(value = "query", required = false) String query) {
        List<PointCaptureDTO> result = pointCaptureService.findAutocomplete(query);
