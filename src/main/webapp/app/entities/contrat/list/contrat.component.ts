...
export class ContratComponent implements OnInit {
  ...
  constructor(protected contratService: ContratService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.contrats = [];
  ...
  loadAll(): void {
    ...
    this.contratService
      ...
      .subscribe({
        next: (res: HttpResponse<IContrat[]>) => {
          this.isLoading = false;
          this.paginateContrats(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
