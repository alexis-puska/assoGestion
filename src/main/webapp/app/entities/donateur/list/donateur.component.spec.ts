...
describe('Donateur Management Component', () => {
  let comp: DonateurComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(DonateurComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.donateurs[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
